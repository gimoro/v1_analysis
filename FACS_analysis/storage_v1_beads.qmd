...
```{r}
fpath<-"/Users/gimoro/Desktop/v1_analysis_thesis/FACS_data/data/test old beads v1"
rdss <- dir(fpath, "*.fcs", 
...
titration<-titration[c(6,5,7,2,1,4,3)]

sampleNames(titration)<-c("pos","neg","unmod","10_egfp","10_dT","s_10_egfp","s_10_dT")
pData(titration)$name<-c("pos","neg","unmod","10_egfp","10_dT","s_10_egfp","s_10_dT")
...
ggcyto(filt_titration, aes(x = FSC.A, y = SSC.A)) + 
  geom_hex(bins = 100) + 
  facet_wrap(~factor(name, levels = c("pos","neg","unmod","10_egfp",
                                      "10_dT","s_10_egfp","s_10_dT"))) +
  geom_gate(beads) + 
  theme_bw() +
  facs_rock_roi_theme_multiple_panels()
...
ggcyto(filt_titration, aes(x = "APC-A", fill = name,color=name)) + 
  ...
  facet_wrap(~factor(name, levels = c("pos","neg","unmod",
                                      "10_egfp","10_dT","s_10_egfp","s_10_dT")),
             ncol=1,switch = "y")+
  theme_bw() +
