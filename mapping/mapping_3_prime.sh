...
GTF=/home/gmoro/star_solo_v1_experiments/mouse_LTRs_egfp_3_prime/combined_correct.gtf
GENOME_FA=/home/gmoro/star_solo_v1_experiments/mouse_LTRs_egfp_3_prime/combined_correct.fa
IDX=/home/gmoro/star_solo_v1_experiments/mouse_LTRs_egfp_3_prime/mouse_LTRs_egfp_3_prime
...
mkdir -p $WD/data_3_prime ; cd $_

# only taking the files where the genome is with the 24 nt capture

ln -s "$FASTQPATH_2"/20220421.A-o28127_1_3-SPECTRAL_3_prime_R1.fastq.gz second_mod_3_prime_r1.fq.gz
ln -s "$FASTQPATH_2"/20220421.A-o28127_1_3-SPECTRAL_3_prime_R2.fastq.gz second_mod_3_prime_r2.fq.gz

mkdir -p "$WD"/star_3_prime ; cd $_

for item in second_mod_3_prime
do
    echo $item
    r2="$WD"/data_3_prime/"$item"_r2.fq.gz
    r1="$WD"/data_3_prime/"$item"_r1.fq.gz
...
rm -rf $WD/star_3_prime/*STARgenome
